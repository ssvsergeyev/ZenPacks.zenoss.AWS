...
class VPNGateways(AWSComponent):
    meta_type = portal_type = 'VPNGateways'
...
class IVPNGatewaysInfo(IComponentInfo):
...
class VPNGatewaysInfo(ComponentInfo):
    implements(IVPNGatewaysInfo)
    adapts(VPNGateways)
